...
const PatientData = () => {
  ...
  const viewTestResults = () => {
    fetch(
      `${apiURL}/patient/all-tests?patientId=${patientId}`,
      ...
      <div className="dashboard-container">
        ...
        <div className="patient-data-wrapper">
          <div className="patient-data-container">
            ...
            <div className="patient-data-div" id="med-his">
              <span className="personal-details-title">
          ...
          <div className="data-test-wrapper">
